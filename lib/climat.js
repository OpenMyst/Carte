/**
 * Adds a cloud layer to the Mapbox map.
 *
 * @param {object} map - The Mapbox map instance.
 */
export const addCloudLayer = (map) => {
  // Create 100 cloud elements and add them to the map
  for (let i = 0; i < 100; i++) {
  ...
  // Add the floating animation for the clouds
...
/**
 * Adds a snow layer to the Mapbox map.
 *
 * @param {object} map - The Mapbox map instance.
 */
export const addSnowLayer = (map) => {
  // Create 1000 snowflake elements and add them to the map
  ...
  // Add the falling animation for the snowflakes
  const styleElement = document.createElement("style");
  styleElement.innerHTML = `
    @keyframes fall {
      0% {
...
/**
 * Adds a rain layer to the Mapbox map.
 *
 * @param {object} map - The Mapbox map instance.
 */
export const addRainLayer = (map) => {
  // Create 1000 raindrop elements and add them to the map
  for (let i = 0; i < 1000; i++) {
    const el = document.createElement("div");
  ...
  // Add the falling animation for the raindrops
  const styleElement = document.createElement("style");
  styleElement.innerHTML = `
    @keyframes fall {
      0% {
...
/**
 * Adds a wind layer to the Mapbox map.
 *
 * @param {object} map - The Mapbox map instance.
 */
export const addWindLayer = (map) => {
  // Create 1000 wind blow elements and add them to the map
  for (let i = 0; i < 1000; i++) {
    const el = document.createElement("div");
  ...
  // Add the blowing animation for the wind
  const styleElement = document.createElement("style");
  styleElement.innerHTML = `
    @keyframes blow {
      0% {
