"use client"
import { MAPBOX_TOKEN, sprintStyleNightSnow } from "@/tool/security";
...
const SnowingMapComponent = () => {
    ...
    const [mapStyle, setMapStyle] = useState(sprintStyleNightSnow);
...
export default SnowingMapComponent;
